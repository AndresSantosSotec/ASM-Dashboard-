          ...
          <Tabs defaultValue="personal" className="w-full" onValueChange={handleTabChange}>
            ...
            <TabsContent value="personal" className="space-y-6">
              ...
              <div className="flex flex-col-reverse sm:flex-row justify-between space-y-4 space-y-reverse sm:space-y-0 sm:space-x-4 mt-6">
                ...
                <Button
                  type="button"
                  onClick={() => {
                    const tab = document.querySelector('[data-value="laboral"]') as HTMLElement | null;
                    tab?.click();
                  }}
            ...
            <TabsContent value="laboral" className="space-y-6">
              ...
              <div className="flex flex-col-reverse sm:flex-row justify-between space-y-4 space-y-reverse sm:space-y-0 sm:space-x-4 mt-6">
                ...
                <Button
                  onClick={() => (document.querySelector('[data-value="academico"]') as HTMLElement)?.click()}
                  className="w-full sm:w-auto"
                >
                  Siguiente <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
            ...
            <TabsContent value="academico" className="space-y-6">
              ...
              <div className="flex flex-col-reverse sm:flex-row justify-between space-y-4 space-y-reverse sm:space-y-0 sm:space-x-4 mt-6">
                <Button
                  variant="outline"
                  className="w-full sm:w-auto gap-2"
                  onClick={() => (document.querySelector('[data-value="laboral"]') as HTMLElement)?.click()}
                >
                  <ArrowLeft className="h-4 w-4" /> Anterior
                </Button>
                <Button
                  onClick={() => {
                    const tab = document.querySelector('[data-value="financiero"]') as HTMLElement | null;
                    tab?.click();
                  }}
                  className="w-full sm:w-auto"
                >
            ...
            <TabsContent value="financiero" className="space-y-6">
              ...
              <div className="flex flex-col-reverse sm:flex-row justify-between space-y-4 space-y-reverse sm:space-y-0 sm:space-x-4 mt-6">
                <Button
                  variant="outline"
                  className="w-full sm:w-auto gap-2"
                  onClick={() => (document.querySelector('[data-value="academico"]') as HTMLElement | null)?.click()}
                >
                  <ArrowLeft className="h-4 w-4" /> Anterior
                </Button>
                <Button
                  onClick={() => {
                    const tab = document.querySelector('[data-value="documentos"]') as HTMLElement | null;
                    tab?.click();
                  }}
                  className="w-full sm:w-auto"
