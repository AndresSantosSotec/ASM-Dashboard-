        ...
        <div className="mb-1">
          ...
          {expandedSections["prospectos"] && (
            <div className="pl-10 text-sm">
              ...
              <Link
                href="/tareas-asesor"
                className={`flex items-center px-4 py-1.5 rounded-md ${pathname === "/tareas-asesor" ? "bg-asm-medium-gold text-white" : "text-asm-light-gold hover:bg-asm-medium-gold/20"}`}
              >
                <ClipboardList size={16} className="mr-2" />
