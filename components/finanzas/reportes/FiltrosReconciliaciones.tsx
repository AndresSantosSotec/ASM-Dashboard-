...
import { conciliacionLabels, LIMIT_OPTIONS } from "@/components/finanzas/reportes/utils"

interface FiltrosReconciliacionesProps {
...
export const FiltrosReconciliaciones = ({
  filters,
  onFiltersChange,
  onSubmit,
  onReset,
  loading,
}: FiltrosReconciliacionesProps) => {
  return (
    <form
      onSubmit={onSubmit}
    ...
    >
      ...
      />
      <Select
        value={filters.estadoReconciliacion}
        onValueChange={(value) => onFiltersChange({ estadoReconciliacion: value })}
      >
