...
import { estadoPagoLabels, LIMIT_OPTIONS } from "@/components/finanzas/reportes/utils"

interface FiltrosKardexProps {
  ...
  return (
    ...
    >
      ...
      <Select
        ...
        onValueChange={(value) => onFiltersChange({ estadoPago: value })}
      >
